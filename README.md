...
[![Slack](https://slack.minio.io/slack?type=svg)](https://slack.minio.io) [![Go Report Card](https://goreportcard.com/badge/minio/minio)](https://goreportcard.com/report/minio/minio) [![Docker Pulls](https://img.shields.io/docker/pulls/minio/minio.svg?maxAge=604800)](https://hub.docker.com/r/hephaex/minio/) [![codecov](https://codecov.io/gh/minio/minio/branch/master/graph/badge.svg)](https://codecov.io/gh/minio/minio)
...
### Stable
```
docker pull hephaex/minio
docker run -p 9000:9000 minio/minio server /data
```

### Edge
```
docker pull hephaex/minio:edge
docker run -p 9000:9000 hephaex/minio:edge server /data
```
...
```sh
go get -u github.com/hephaex/minio
```

## Test using Minio Browser
Minio Server comes with an embedded web based object browser. Point your web browser to http://127.0.0.1:9000 ensure your server has started successfully.

![Screenshot](https://github.com/hephaex/minio/blob/master/docs/screenshots/minio-browser.jpg?raw=true)
